...
((global, exports) => {
  ...
  Vinyl.Color = {
    ...
    EASTER_YELLOW:      { color: new THREE.Color(0xfbe867), opacity: 1.0, reflectivity: 0.1, refractionRatio: 0.98, shininess:  15, metal: true },
    RED:                { color: new THREE.Color(0xbb0016), opacity: 1.0, reflectivity: 0.1, refractionRatio: 0.98, shininess:  15, metal: true },
    ...
    DEEP_PURPLE:        { color: new THREE.Color(0x580036), opacity: 0.85, reflectivity: 0.3, refractionRatio: 0.98, shininess:  25, metal: true },
    ROYAL_BLUE:         { color: new THREE.Color(0x003079), opacity: 0.9, reflectivity: 0.6, refractionRatio: 0.98, shininess:  25, metal: true },
    ...
    SEA_BLUE:           { color: new THREE.Color(0x00354d), opacity: 0.85, reflectivity: 0.3, refractionRatio: 0.98, shininess:  25, metal: true },
    ...
    ELECTRIC_BLUE:      { color: new THREE.Color(0xa2f5ff), opacity: 0.7, reflectivity: 0.6, refractionRatio: 0.98, shininess:  25, metal: true },
    ...
    COKE_BOTTLE_GREEN:  { color: new THREE.Color(0x6ec797), opacity: 0.55, reflectivity: 0.6, refractionRatio: 0.98, shininess:  25, metal: true },
    ...
    GOLD:               { color: new THREE.Color(0x846537), opacity: 1.0, reflectivity: 0.1, refractionRatio: 0.98, shininess:  25, metal: true },
    SILVER:             { color: new THREE.Color(0x727476), opacity: 1.0, reflectivity: 0.1, refractionRatio: 0.98, shininess:  25, metal: true },
    MUSTARD:            { color: new THREE.Color(0xf8c772), opacity: 1.0, reflectivity: 0.1, refractionRatio: 0.98, shininess:  15, metal: true },
