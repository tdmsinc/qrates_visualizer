...
((global, exports) => {
  ...
  class Sleeve {
    ...
    //--------------------------------------------------------------
    setGatefoldCoverAngle(angle /* in radians */) {
